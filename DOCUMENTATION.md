...
1. [Build Jobs](#build-jobs)
  - [🌐 Web Builds - GitHub Action](#🌐-web-builds---github-action)
  - [🏁 Windows Builds - GitHub Action](#🏁-windows-builds---github-action)
  - [Mono Glue Build - GitHub Action](#mono-glue-build---github-action)
  - [🐧 Linux Builds GitHub Action](#🐧-linux-builds-github-action)
  - [🍎 macOS Builds GitHub Action](#🍎-macos-builds-github-action)
  - [🍏 iOS Builds GitHub Action](#🍏-ios-builds-github-action)
2. [Github Actions](#github-actions)
  - [Blazium Cerebro Build (Completed) - GitHub Action](#blazium-cerebro-build-completed---github-action)
  - [Blazium Cerebro Deploy - GitHub Action](#blazium-cerebro-deploy---github-action)
  - [Blazium Cerebro Get Run Build Data - GitHub Action](#blazium-cerebro-get-run-build-data---github-action)
  - [Blazium Cerebro Get Multiple Run Build Data - GitHub Action](#blazium-cerebro-get-multiple-run-build-data---github-action)
  - [Blazium Cerebro Build (Failed) - GitHub Action](#blazium-cerebro-build-failed---github-action)
  - [Blazium Cerebro Build (Started) - GitHub Action](#blazium-cerebro-build-started---github-action)
  - [Generate SHA-256 Checksums - GitHub Action](#generate-sha-256-checksums---github-action)
  - [Parse version.py - GitHub Action](#parse-versionpy---github-action)
  - [Rename and Copy Files Action - GitHub Action](#rename-and-copy-files-action---github-action)  
  - [Upload Files to DigitalOcean Spaces - GitHub Action](#upload-files-to-digitalocean-spaces---github-action)  
  - [Rename and Zip Folders Action - GitHub Action](#rename-and-zip-folders-action---github-action)
  - [Rename Files in Place Action - GitHub Action](#rename-files-in-place-action---github-action)
  - [Uncompress Files Action - GitHub Action](#uncompress-files-action---github-action)
  - [Set version.py - GitHub Action](#set-versionpy---github-action)  
  - [Uncompress File Action - GitHub Action](#uncompress-file-action---github-action)
  - [Do we Compile? or do we Skip? - GitHub Action](#do-we-compile-or-do-we-skip---github-action)
  - [Parse Changelog Version - GitHub Action](#parse-changelog-version---github-action)
